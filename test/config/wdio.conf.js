...
const reporterOptions = {
    theme: 'bootstrap',
    jsonFile: path.join(__dirname, '../../test/reports/interaction-on-home-page.json'),
    output: path.join(__dirname, '../../test/reports/cucumber_report.html'),
...
exports.config = {
    ...
    cucumberOpts: {
        ...
        require: [
            path.resolve('./test/step_definitions/**/*.js')
        ],
